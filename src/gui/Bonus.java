...
public class Bonus extends PongItem{
	...
	//si True le bonus est toujours sur le pong, si false, le bonus a traverse le pong et a ete utilise ou detruit
	...
	/*
	 * Liste des bonus applicable aux raquettes ou à la balle
	 */
